...
mealType: "dinner"
tags: ["chicken", "comfort", "weeknight"]
ingredients:
  - { qty: 2,    unit: "lb",   item: "boneless skinless chicken breasts", note: "pounded to ½ inch" }
  - { qty: 1,    unit: "cup",  item: "all-purpose flour" }
  - { qty: 3,    unit: null,   item: "large eggs", note: "beaten with 1 tbsp water" }
  - { qty: 2,    unit: "cup",  item: "panko breadcrumbs" }
  - { qty: 0.75, unit: "cup",  item: "grated parmesan", note: "divided" }
  - { qty: 1,    unit: "tsp",  item: "garlic powder" }
  - { qty: 1,    unit: "tsp",  item: "dried oregano" }
  - { qty: 0.5,  unit: "cup",  item: "neutral oil for frying" }
  - { qty: 3,    unit: "cup",  item: "marinara sauce", note: "warmed" }
...
- For extra-crisp crust, double-bread: flour → egg → panko → egg → panko.
- The pounding step is non-negotiable — even thickness is what makes it cook evenly without drying out.
- Pairs with simple buttered spaghetti or a sharp arugula salad to cut the richness.
