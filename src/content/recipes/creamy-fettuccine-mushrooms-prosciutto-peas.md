---
title: "Creamy Fettuccine with Mushrooms, Prosciutto, and Peas"
description: "A Roman trattoria-style fettuccine alla boscaiola — silky cream, golden mushrooms, prosciutto, and sweet peas in 25 minutes."
image: "/images/recipes/creamy-fettuccine-mushrooms-prosciutto-peas.jpg"
servings: 3
prepTime: "10 min"
cookTime: "15 min"
cuisine: "Italian"
mealType: "dinner"
tags: ["pasta", "italian", "comfort", "weeknight", "boscaiola"]
sources:
  - title: "Inspiration: Gioia Mia Pisciapiano (Rome) — diner photo"
    url: "https://photos.app.goo.gl/ENtrjXJX9zTeHZrP7"
ingredients:
  - { qty: 10,   unit: "oz",   item: "fettuccine", note: "fresh preferred, dried works" }
  - { qty: 1,    unit: "cup",  item: "cremini or button mushrooms", note: "thinly sliced" }
  - { qty: 2,    unit: "oz",   item: "prosciutto", note: "crudo or cotto, thin ribbons" }
  - { qty: 0.5,  unit: "cup",  item: "frozen sweet peas" }
  - { qty: 2,    unit: null,   item: "garlic cloves", note: "minced" }
  - { qty: 1,    unit: null,   item: "shallot", note: "finely diced" }
  - { qty: 1,    unit: "cup",  item: "heavy cream" }
  - { qty: 0.5,  unit: "cup",  item: "freshly grated Parmesan", note: "plus more for serving" }
